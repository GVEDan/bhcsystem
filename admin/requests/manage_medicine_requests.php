...
if (isset($_GET['action']) && isset($_GET['id'])) {
    ...
    if (array_key_exists($action, $status_map)) {
        if (MedicineRequest::updateStatus($request_id, $status_map[$action], $admin_notes)) {
...
$stats = MedicineRequest::getStatistics();
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Manage Medicine Requests - CLINICare</title>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="manage_medicine_requests.php">Medicine Requests</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container-fluid py-4">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-4">
                <div class="sidebar">
                    ...
                    <a href="manage_medicine_requests.php" class="nav-link active"><i class="fas fa-pills"></i> Medicine Requests</a>
                    <a href="manage_consultation_requests.php" class="nav-link"><i class="fas fa-stethoscope"></i> Consultation Requests</a>
        ...
        <div class="row">
            <div class="col-lg-12">
                <!-- Header -->
                <div class="mb-4">
                    <h1 class="h2 mb-2"><i class="fas fa-pills"></i> Medicine Requests</h1>
                    <p class="text-muted">Manage patient medicine requests</p>
                </div>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-3">
                        <div class="stat-box">
                            <div class="stat-number"><?php echo count($medicine_requests); ?></div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0"><i class="fas fa-list"></i> All Medicine Requests</h5>
                    </div>
                    <div class="card-body">
                        <?php if (empty($medicine_requests)): ?>
                            <div class="alert alert-info" role="alert">
                                <i class="fas fa-info-circle"></i> No medicine requests yet.
                            </div>
                        <?php else: ?>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title">Update Medicine Request</h5>
                                                        ...
                                                        <form method="POST">
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <p><?php echo htmlspecialchars($request['medicine_name']); ?></p>
                                                                </div>
                                                                <div class="mb-3">
